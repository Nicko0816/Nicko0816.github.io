	...
	<div class="col-lg-12">
		...
		<div class="row">
			...
			while($row=$folders->fetch_assoc()):
						...
						$name = isset($name[1]) ? $name[0] ." (".$name[1].").".$row['name'] : $name[0];

			?>
				<div class="card col-md-3 mt-2 ml-2 mr-2 mb-2 folder-item" data-id="<?php echo $row['id'] ?>">
					<div class="card-body">

						<tr class='file-item'  data-name="<?php echo $name ?>">
							<td><large><span><i class="fa <?php echo $icon ?>"></i></span><b class="to_file"> <?php echo $name ?></b></large>					</div>
				</div>
			<?php endwhile; ?>
		</div>
		<hr>
