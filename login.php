...
<style>
	...
	#login-left{
		...
		width:60%;
		height: calc(100%);
		    	background-image: url(assets/img/Bu.jpeg);
		display: flex;
		align-items: center;
...
<body>
  ...
  <main id="main" class=" alert-info"><br><br><br><br><br><br>
<a href="" class="link">HOME</a><a href="" class="link">INFO BOARD</a><a href="" class="link">ABOUT</a>
